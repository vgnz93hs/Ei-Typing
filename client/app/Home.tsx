...
export default function Home() {
    ...
    return (
        <div className="flex flex-col justify-center h-full items-center gap-16">
            ...
            <button
                data-cursor="button"
                className="group pr-2 pl-1.5 flex items-center py-1 text-cyan-600 rounded-md font-bold transition-transform duration-200 ease-out active:scale-95 z-1000"
                data-cursor-shape="1"
